...
<input name="searchFiles"  id="auth" type="submit"  value="Search Files"/>
<div id="filesdiv">
<p>
Select a file to download from below list
</p>
<p>${files}</p>
<input name="filename" />
<input  id="auth" name="filebutton" type="submit" value="Search Peers"/>
</div>
