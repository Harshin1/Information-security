...
<div id="peerlist" >
<p>Below are the list of peers available for download with their scores & no.of downloads:</p>
<p>
 ${PeerList}
 </p>
 <p>Select any peer to download file:</p>
 <input name="peername" />
<input name="peerbutton" id="auth" type="submit" value="Download"/>
<p>${LowScoreError}</p>
